...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado apareció en una filtración de datos. Elegí un :attribute diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres en español de los campos que más se usan en los formularios del
    | sistema, para que el mensaje diga "El campo razón social..." en vez de
    | "El campo razon_social...".
    */
