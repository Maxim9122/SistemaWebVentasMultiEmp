...
class ConfirmarImportacionClientesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'mapeo.*' => ['nullable', 'string', 'in:'.implode(',', MapeoColumnasClienteService::CAMPOS)],
        ];
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            // El CUIT / DNI es opcional a propósito: es normal que no todos
            // los clientes de un Excel real lo tengan cargado. Sin esa
            // columna mapeada, cada fila entra siempre como alta nueva (no
            // hay con qué identificar si ya existía) — se avisa la cantidad
            // en el resumen final, no se bloquea la importación.
    ...
    {
        $datos = Cache::get('import-clientes:'.$this->input('token'));
